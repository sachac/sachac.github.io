...
#+CALL: graph-from-tables[:file goals.svg :cmdline "-Kdot -Tsvg -Gdpi=100 -Gsize=8,8 -Grankdir=LR"](fillcolumn=20) :results silent :exports none
...
#+CALL: graph-from-tables[:file someday.svg :cmdline "-Kdot -Tsvg -Gsize=10,10 -Grankdir=LR"](fillcolumn=20,include-someday=1) :results silent :exports none
...
*** enrich our experiences
    ...
    :END:
So that I can [[live an awesome life]]
**** WAITING get Canadian passport                                     :Life:
     :PROPERTIES:
     :GoalCategory: Life
     :XP:       5
...
**** SOMEDAY make Sketchnotes 2014                                  :Drawing:
     :PROPERTIES:
     :GoalCategory: Drawing
     :XP:       5
...
**** SOMEDAY make special types of bread, including sourdough       :Cooking:
     ...
     :END:
 So that I can [[practise types of recipes][practise types of recipes]]
**** TODO make udon noodles from scratch                            :Cooking:
     :PROPERTIES:
     :GoalCategory: Cooking
     :XP:       5
...
#+BEGIN_SRC emacs-lisp :var fill-column=20 :var tag="goal" :results none

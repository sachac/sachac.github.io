...
#+CALL: graph-from-tables[:outputfile "goals.svg" :cmdline "-Kdot -Tsvg -Gdpi=72 -Gsize=8,8 -Grankdir=LR"](fillcolumn=20,id="G") :results silent :exports none
...
#+CALL: graph-from-tables[:outputfile "someday.svg" :cmdline "-Kdot -Tsvg -Gdpi=72 -Gsize=10,10 -Grankdir=LR"](fillcolumn=20,include-someday=1) :results silent :exports none
